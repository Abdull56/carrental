...
function StackBar() {
  return (
    <Stack.Navigator>
        ...
        <Stack.Screen name="Car Details" component={DescriptionPage} options={{ headerShown: true, headerStyle:{
          backgroundColor:'#FFE5E5'
        }, contentStyle: { backgroundColor: '#FFE5E5' } }} />
        <Stack.Screen name="AvailableCars" component={AvailableCar} options={{ headerShown: false }} />
    </Stack.Navigator>
  )
}
